              ...
              return (
                <div key={index} className="relative">
                  ...
                  <motion.div
                    ...
                    className="absolute -left-[30px] md:-left-[54px] top-1.5 w-4 h-4 rounded-full bg-white border-2 border-[#6B705C] flex items-center justify-center z-10"
                  >
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-2.5 mb-4">
                      <div>
                        {/* Session Date Badge */}
                        <div className="inline-flex items-center space-x-1.5 px-3 py-1 bg-[#6B705C]/10 text-[#6B705C] rounded-full text-[10px] font-mono uppercase tracking-wider font-bold mb-2">
                    ...
                    <p className="font-sans text-[13px] sm:text-[14px] text-[#5A6050] leading-relaxed mb-5 border-l-2 border-[#6B705C]/35 pl-3">
                      {item.description}
                    </p>
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          {item.details.map((detail, dIdx) => (
                            <li key={dIdx} className="flex items-start space-x-2 text-[12px] text-[#5A6050]">
                              <CheckCircle className="w-3.5 h-3.5 text-[#6B705C] mt-0.5 flex-shrink-0" />
                              <span>{detail}</span>
                            </li>
                          ))}
                        </ul>
